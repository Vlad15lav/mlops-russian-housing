# -*- coding: utf-8 -*-
#
# MLOps Russian Real Estate Price Prediction documentation
...
project = u'MLOps Russian Real Estate Price Prediction'

# The version info for the project you're documenting,
# acts as replacement for
# |version| and |release|, also used in various other
...
# you set today to some non-false value, then it is used:
# today = ''
...
# Add any paths that contain custom themes here, relative
# to this directory.
# html_theme_path = []
...
# as favicon of the docs.
# This file should be a Windows icon file (.ico)
...
# If not '', a 'Last updated on:' timestamp is inserted
...
# The value of this option must be the
...
htmlhelp_basename = 'mlops-russian-housingdoc'
...
# title, author, documentclass [howto/manual]).
latex_documents = [
    ('index',
     'mlops-russian-housing.tex',
     u'MLOps Russian Real Estate Price Prediction Documentation',
     u"Vlad15lav", 'manual'),
]
...
# toplevel headings are parts, not chapters.
...
texinfo_documents = [
    ('index',
     'mlops-russian-housing',
     u'MLOps Russian Real Estate Price Prediction Documentation',
     u"Vlad15lav", 'MLOps Russian Real Estate Price Prediction',
     'MLOps project description', 'Miscellaneous'),
]
